def populate_robject(robject)
  ...
  robject.define(rhash[[rstring, rstring]], bind_to: 'ENV')
  ...
  rrange.define(Rfunc.new('map', rarray[[_U]], [], block_sig: FnSig.new(_U, [_T])))
  ...
  rarray.define(Rfunc.new('clear', rarray[[_T]], []))
  rarray.define(Rfunc.new('push', rarray[[_T]], [_T]))
  # XXX doesn't work yet
  #rarray.define(Rfunc.new('zip', rarray[[rtuple[[_T, _U ]] ]], [rarray[[_U]]]))
  rarray.define(Rfunc.new('<<', rarray[[_T]], [_T]))
  rarray.define(Rfunc.new('*', rarray[[_T]], [rinteger]))
  rarray.define(Rfunc.new('uniq', rarray[[_T]], []))
  rarray.define(Rfunc.new('uniq!', rarray[[_T]], []))
  ...
  rarray.define(Rfunc.new('select', rarray[[_T]], [], block_sig: FnSig.new(rboolean, [_T])))
